...
public class welcomePatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mUser == null){
            ...
            mDatabase.child("Patient").child(mUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    String display = "Welcome " + name + "! You are logged in as a patient";
        ...
        next.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(welcomePatient.this, patientProfile.class));
                finish();
            }
        });
